...
/**
 * SLIDE 7: Gradient Fill Text
 * @param {PptxGenJS} pptx
 */
function genSlide07(pptx) {
	let slide = pptx.addSlide({ sectionTitle: "Text" });
	slide.addNotes("API Docs: https://gitbrent.github.io/PptxGenJS/docs/api-text.html");
	slide.addTable([[{ text: "Text Examples: Gradient Fill", options: BASE_TEXT_OPTS_L }, BASE_TEXT_OPTS_R]], BASE_TABLE_OPTS);

	// Test gradient fill with different angles
	slide.addText("Gradient Fill (0°)", { 
		x: 0.5, 
		y: 0.7, 
		w: 6.0, 
		h: 1.0, 
		...
		fill: { 
			...
			gradientStops: [
				...
				{ color: '00FF00', position: 100 }   // Green at end
			],
			gradientAngle: 0
		}
	});

	slide.addText("Gradient Fill (45°)", { 
		x: 7.0, 
		y: 0.7, 
		w: 6.0, 
		h: 1.0, 
	...
	// Test gradient fill with multiple stops
	slide.addText("Multi-Stop Gradient", { 
		x: 0.5, 
		y: 2.0, 
		w: 6.0, 
		h: 1.0, 
		...
		fill: { 
			...
			gradientStops: [
				{ color: 'FF0000', position: 0 },    // Red at start
				{ color: 'FFFF00', position: 50 },   // Yellow in middle
				{ color: '00FF00', position: 100 }   // Green at end
			],
			gradientAngle: 90
		}
	...
	// Test gradient fill with transparency
	slide.addText("Gradient with Transparency", { 
		x: 7.0, 
		y: 2.0, 
		w: 6.0, 
		h: 1.0, 
	...
	// Test gradient fill with different colors
	slide.addText("Blue to Purple Gradient", { 
		x: 0.5, 
		y: 3.3, 
		w: 6.0, 
		h: 1.0, 
		...
		fill: { 
			type: 'gradient',
			gradientStops: [
				{ color: '0000FF', position: 0 },    // Blue at start
				{ color: '800080', position: 100 }   // Purple at end
			],
			gradientAngle: 270
		}
	});

	// Test gradient fill with theme colors
	slide.addText("Theme Color Gradient", { 
		x: 7.0, 
		y: 3.3, 
		w: 6.0, 
		h: 1.0, 
		...
		fill: { 
			type: 'gradient',
			gradientStops: [
				{ color: pptx.SchemeColor.accent1, position: 0 },    // Accent1 at start
				{ color: pptx.SchemeColor.accent6, position: 100 }   // Accent6 at end
			],
			gradientAngle: 315
		}
	});
